const config = {
    ...
    body: {
        ...
        onZoomChanged: (args) => {
            ...
            if (args.zoom > 400) step = 5;
            else if (args.zoom > 200) step = 10;
            else step = 20;

            mapChart.updateOptions({
                axis: {
                    grid: {
                        line: {
                            step,
    ...
    axis: {
        ...
        guide: [
            ...
            },
            {
                ...
                from: 23,
                to: -23,
                style: { stroke: 'none', fill: 'orange', opacity: 0.5 },
            },
        ],
    },
    series: [
        {
            ...
            useMapData: true,
            tooltipText:
                '<t style="font-size:14; font-weight: 700;">${name}(${iso-a3})</t>',
            style: {
                stroke: '#fff',
                fill: '#B4CBEF',
                strokeWidth: 0.7,
        ...
        },
        {
            ...
            data: [
                { name: '그리니치 천문대', coord: [-0.0015, 51.4779] },
                { name: '영점(Zero Point)', coord: [0, 0], color: '#4170B7' },
                { name: '서울', coord: [127.061, 37.3045], color: '#4170B7' },
            ],
        },
        {
            type: 'point',
            ...
            data: [{ name: '서울', coord: [127.061, 37.3045] }],
        },
    ],
};
